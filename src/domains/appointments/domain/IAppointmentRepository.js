...
export class IAppointmentRepository {
   ...
   */
  async findBlockedSlots(date) { throw new Error('Not implemented'); }

  /**
   * @param {string} date
   * @returns {Promise<string[]>} - Returns array of available 'HH:mm'
   */
  async findAvailableSlots(date) { throw new Error('Not implemented'); }

  /**
   * @param {import('./Appointment.entity').Appointment} appointment
   * @returns {Promise<import('./Appointment.entity').Appointment>}
   */
  async save(appointment) { throw new Error('Not implemented'); }

  /**
   * @param {import('./Appointment.entity').Appointment} appointment
   * @returns {Promise<import('./Appointment.entity').Appointment>}
   */
  async update(appointment) { throw new Error('Not implemented'); }
   ...
   * @returns {Promise<import('./Appointment.entity').Appointment | null>}
   */
  async cancel(id, reason) { throw new Error('Not implemented'); }
}
